...
#
# Tags look like `v<APISIX version>-<release>`:
#
# - if defaults/main.yml points at an APISIX version that has never been
#   released, the release counter restarts at 0 (`v3.18.0-0`)
# - otherwise the counter is incremented (`v3.18.0-1`), but only if something
